...
<spark-api-execute-button device="FrameCtrlVM.device" text="Turn LED on" params="on" endpoint="led"></spark-api-execute>

Pretty cool! Now turn it off:

<spark-api-execute-button device="FrameCtrlVM.device" text="Turn LED off" params="off" endpoint="led"></spark-api-execute>
...
Enjoy!
      <spark-api-variable device="FrameCtrlVM.device"></spark-api-variable>
      <spark-api-execute device="FrameCtrlVM.device"></spark-api-execute>
